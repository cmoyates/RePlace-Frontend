...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	function footer_currentColor_binding(value) {
    		/*footer_currentColor_binding*/ ctx[5](value);
    	}

    	let footer_props = { colors: /*COLORS*/ ctx[4] };
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "place svelte-19dxxu3");
    			add_location(span, file, 78, 8, 2489);
    			attr_dev(h1, "class", "svelte-19dxxu3");
    			add_location(h1, file, 78, 1, 2482);
    			attr_dev(a, "href", "https://www.reddit.com/r/place/");
    			add_location(a, file, 79, 16, 2543);
    			add_location(p, file, 79, 1, 2528);
    			...
    			attr_dev(canvas_1, "class", "svelte-19dxxu3");
    			add_location(canvas_1, file, 81, 1, 2681);
    			attr_dev(main, "class", "svelte-19dxxu3");
    			add_location(main, file, 77, 0, 2474);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*$canvasOpacity*/ 2) {
    				set_style(canvas_1, "opacity", /*$canvasOpacity*/ ctx[1]);
    			}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ('canvasOpacity' in $$props) $$invalidate(2, canvasOpacity = $$props.canvasOpacity);
